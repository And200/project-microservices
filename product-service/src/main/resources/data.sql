...
VALUES ( 'Pan Rollo','Pan de Rollo',100,223.2,'CREATED','2022-12-05',1);

INSERT INTO products ( name, description, stock,price,status, create_date,category_id)
VALUES ( 'Pan Hojaldre','Pan de Hojaldre Preparado con hogaza madre',100,122.5,'CREATED','2022-09-05',1);


INSERT INTO products ( name, description, stock,price,status, create_date,category_id)
VALUES ( 'Pan Relleno','Pan Relleno de jamon y queso',100,400.06,'CREATED','2022-11-05',2);